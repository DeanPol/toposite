...
const services = [
  ...
  {
    title: "ΣΧΕΔΙΑΣΜΟΣ ΕΣΩΤΕΡΙΚΗΣ ΟΔΟΠΟΙΙΑΣ ΑΚΙΝΗΤΩΝ",
    image: "/images/service_8.webp",
    longDescription: "Μελέτες οδοποιίας και κυκλοφοριακών συνδέσεων.",
    subServices: [],
  },
  {
    ...
    longDescription:
      "Το γραφείο μελετά και σχεδιάζει χώρους πρασίνου με γνώμονα τη καλαίσθητη μετατροπή του χώρου, τις κατάλληλες κλίσεις για την απορροή τον υδάτων και τη δημιουργία μικροκλίματος με την επιλογή των κατάλληλων συστημάτων σκίασης σε συνδιασμό με τα ιδανικά φυτά-δέντρα, προσαρμοσμένο στις ανάγκες του πελάτη.",
  },
];
